...
// ============================================================
import { supabase, getCurrentUser, getCurrentSession, login, register, logout, resetPassword, updatePassword, getUserRole, isAdmin, logActie } from './supabase.js';
...
export async function loginUser(email, password, redirectUrl = 'dashboard.html') {
  try {
    ...
    // 🔥 LOG: Ingelogd
    await logActie('ingelogd', 'auth', null, null, { email: email });
...
export async function updateUserPassword(newPassword) {
  try {
    ...
    await logActie('wachtwoord gewijzigd', 'auth');
