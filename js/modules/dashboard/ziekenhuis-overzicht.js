// ============================================================
// MODULE - ZIEKENHUIS OVERZICHT (Alle ziekenhuizen met status)
// ============================================================
...
export async function laadZiekenhuisOverzicht() {
  ...
  try {
    ...
    // 🔥 SECTIE 1: Actieve ziekenhuizen (uitklapbaar)
    if (actief.length > 0) {
      html += `
    ...
    // 🔥 SECTIE 2: Onvoldoende data (standaard uitgeklapt)
    ...
    // 🔥 SECTIE 3: Geen ophalingen (standaard uitgeklapt)
